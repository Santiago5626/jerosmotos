  ...
  return (
    <section id="catalogo" className="featured-catalog container my-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="fw-bold mb-0">Nuestros vehículos destacados</h2>
        {vehiculos.length > 3 && (
                    ...
                    <div className="mb-3 flex-grow-1">
                      {vehiculo.cilindraje && (
                        <div className="d-flex align-items-center mb-1">
                          ...
                          <span className="text-muted small">{vehiculo.cilindraje}</span>
                        </div>
                      )}
                      {vehiculo.color && (
                        <div className="d-flex align-items-center mb-1">
                          <i className="fas fa-palette text-muted me-2"></i>
                          <span className="text-muted small">{vehiculo.color}</span>
                        </div>
                      )}
                    </div>
